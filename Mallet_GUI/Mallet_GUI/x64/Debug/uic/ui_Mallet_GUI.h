...
public:
    ...
    QLineEdit *ipLine;
    QLineEdit *portLine;
    QRadioButton *shellRadio;
    QRadioButton *meterpreterRadio;
    ...
    void setupUi(QWidget *Mallet_GUIClass)
    {
        ...
        tabWidget->setGeometry(QRect(20, 260, 251, 211));
        templates = new QWidget();
        templates->setObjectName("templates");
        verticalLayout = new QVBoxLayout(templates);
        verticalLayout->setSpacing(6);
        verticalLayout->setContentsMargins(11, 11, 11, 11);
        verticalLayout->setObjectName("verticalLayout");
        ipLine = new QLineEdit(templates);
        ipLine->setObjectName("ipLine");

        verticalLayout->addWidget(ipLine);

        portLine = new QLineEdit(templates);
        portLine->setObjectName("portLine");

        verticalLayout->addWidget(portLine);

        shellRadio = new QRadioButton(templates);
        shellRadio->setObjectName("shellRadio");

        verticalLayout->addWidget(shellRadio);

        meterpreterRadio = new QRadioButton(templates);
        meterpreterRadio->setObjectName("meterpreterRadio");

        verticalLayout->addWidget(meterpreterRadio);

        tabWidget->addTab(templates, QString());
        ...
        runButton->setGeometry(QRect(480, 450, 131, 31));
        optionsBox = new QGroupBox(Mallet_GUIClass);
        optionsBox->setObjectName("optionsBox");
        optionsBox->setGeometry(QRect(290, 20, 361, 411));
        QFont font;
        font.setBold(false);
        ...
        formLayout_2->setWidget(3, QFormLayout::LabelRole, encLabel);

        encLabel_2 = new QLabel(optionsBox);
        encLabel_2->setObjectName("encLabel_2");

        formLayout_2->setWidget(4, QFormLayout::LabelRole, encLabel_2);
        ...
        formLayout_2->setWidget(11, QFormLayout::FieldRole, callsCombo);
        ...
        quickModeButton->setGeometry(QRect(330, 450, 131, 31));
    ...
    void retranslateUi(QWidget *Mallet_GUIClass)
    {
        ...
        ipLine->setPlaceholderText(QCoreApplication::translate("Mallet_GUIClass", "Listener IP", nullptr));
        portLine->setPlaceholderText(QCoreApplication::translate("Mallet_GUIClass", "Listener Port", nullptr));
        shellRadio->setText(QCoreApplication::translate("Mallet_GUIClass", "Shell", nullptr));
        meterpreterRadio->setText(QCoreApplication::translate("Mallet_GUIClass", "Meterpreter", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(templates), QCoreApplication::translate("Mallet_GUIClass", "Templates", nullptr));
        fileButton->setText(QCoreApplication::translate("Mallet_GUIClass", "Select File", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(CustomShellcode), QCoreApplication::translate("Mallet_GUIClass", "Custom Shellcode", nullptr));
